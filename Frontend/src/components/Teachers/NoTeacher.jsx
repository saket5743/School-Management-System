    ...
    <div className="flex">
      ...
      <div>
        ...
        <div className="flex justify-between items-center w-full max-w-[1115px] h-[69px] px-[14px] py-[16px] ml-20">
          <div className="text-lg font-semibold text-[#4F4F4F]">Teachers</div>
          <div className="flex gap-4">
            <button className="bg-white text-black px-4 py-2 rounded-[4px] border border-gray-300">
              Export CSV
            </button>
            <button onClick={()=>navigate('/addteachers')} className="bg-[#509CDB] text-white px-4 py-2 rounded-[4px]">
              Add Teachers
            </button>
          </div>
        </div>
        ...
        <div className='mt-5 w-[1020px] h-[419px] ml-[180px] flex justify-end items-end'>
          <div className='flex flex-col justify-end items-end w-[850px]'>
            <div className='w-[830px] h-[35px] flex justify-center items-center'>
            <p className='text-[#4F4F4F] ml-6 text-xl'>No Teachers at this time</p>
            </div>
            <div className='w-[830px] h-[35px] flex justify-center items-center'>
            <p className='text-[#4F4F4F]  text-sm'>Teachers will appear here after they enroll in your school.</p>
            </div>
          </div>
